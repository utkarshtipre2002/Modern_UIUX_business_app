    ...
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          ...
          elit. Soluta provident deleniti aspernatur tempore.
          Odio libero cumque labore! Molestiae expedita
          voluptatum quas ea dolor! Earum repudiandae impedit
          dignissimos, rem maiores voluptatem?
        </p>
